...
public:
    ...
    AudioProcessingModule::AudioProcessingModule(int aec_type=0, bool enable_ns=false, int agc_type=0, bool enable_vad=false, int sample_rate=16000, int sample_channels=1);
